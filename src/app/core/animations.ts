...
export const fuseAnimations = [
  ...
  trigger('routerTransitionLeft', [
    ...
    transition('* => *', [
      query('flox-content > :enter, flox-content > :leave', [
        style({
          position: 'absolute',
          top: 0,
          bottom: 0,
      ...
      sequence([
        ...
        query('flox-content > :leave', animateChild(), {optional: true}),
        query('flox-content > :enter', animateChild(), {optional: true})
      ])
    ])
  ]),
