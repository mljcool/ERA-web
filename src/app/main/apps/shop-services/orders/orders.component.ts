...
import { ShopOrdersService } from "./orders.service";
...
export class ShopOrdersComponent implements OnInit, OnDestroy {
     ...
     * Constructor
     *
     * @param {ShopOrdersService} _ecommerceOrdersService
     */
    constructor(private _ecommerceOrdersService: ShopOrdersService) {
...
export class FilesDataSource extends DataSource<any> {
     ...
     */
    constructor(
        private _ecommerceOrdersService: ShopOrdersService,
